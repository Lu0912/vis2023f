...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>工作室和替代空間的藝術工作者加起來超過此問卷的50%</li>
    <li>大多數藝術工作者前三種減少碳排放量的方式為：1.減少包裝 2.使用無毒媒材、再生材料、廢物利用素材等 3.節約能源</li>
  </ul>
</h3>`
)}

function _10(htl){return(
htl.html`<h2>參數和函數</h2>`
)}
...
d3
  ...
  .range(["#2EA9DF","#6A4C9C","#A8D8B9","#FBE251","#F75C2F","#DC9FB4"])
  .unknown("#ECB88A")
)}
